...
- **CSV Data Export:** Save simulation output with unit-tagged headers for external analysis. Future updates will include import options for experimental data and automatic time-domain building.
